...
@section('contents')
    ...
    <div class="table-responsive">
        <table id="alternatifTable" class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <form action="{{ route('alternatif.destroy', $rs->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Delete?')">
                                        @csrf
                                        @method('DELETE')
